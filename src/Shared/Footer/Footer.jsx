            ...
            <div className="max-w-7xl mx-auto px-8  py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  md:gap-10">
                    <div className="w-full  space-y-3">
                        <h3 className="text-3xl font-bold mt-5">Car &  <span className="text-primary">Doctor</span></h3>
                    ...
                    <a className="hover:underline hover:text-primary" href="">About</a>
                    <a className="hover:underline hover:text-primary" href="">All artCruft</a>
                    <a className="hover:underline hover:text-primary" href="">Add cruft</a>
                    <a className="hover:underline hover:text-primary" href="">My artCruft</a>
                    </div>
                    </div>
                    ...
                    <div className="text-center">
                        <p>Copyright © <span>{currentYear}</span> Car & Doctor, All rights reserved. Present by MoxCreative</p>
                    </div>
            </div>
        </div>
    );
